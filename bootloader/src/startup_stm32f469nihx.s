 ...
 * @author    Auto-generated by STM32CubeIDE (Modified for Bare-Metal C++ System)
 * @brief     STM32F469NIHx device vector table for GCC toolchain.
 * This module performs:
 * - Set the initial SP
 * - Hardware FPU Activation Fix
...
Reset_Handler:
  ...
  /* --------------------------------------------------------------------------
   * HARDWARE FIX: Enable CP10 and CP11 Coprocessors (The Hardware FPU)
   * Essential before calling any compiled C++ code or system init functions.
   * -------------------------------------------------------------------------- */
  ldr     r0, =0xE000ED88           /* SCB->CPACR Address */
  ldr     r1, [r0]                  /* Read CPACR */
  orr     r1, r1, #(0xF << 20)      /* Full access permissions for CP10 & CP11 */
...
* As they are weak aliases, any function with the same name will override them.
*
*******************************************************************************/
  .weak	NMI_Handler
